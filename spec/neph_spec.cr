...
describe Neph do
  ...
  it "Can define job dependencies" do
    exec_neph("dependencies.yaml", "job0")
  ...
  it "Can specify job" do
    exec_neph("specify.yaml", "specify1")
  ...
  it "import feature (Specify multiple imports)" do
    exec_neph("import.yaml", "import_main")
